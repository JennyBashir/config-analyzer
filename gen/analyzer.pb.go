...
const file_analyzer_proto_rawDesc = "" +
	...
	"\x06issues\x18\x01 \x03(\v2\x0f.analyzer.IssueR\x06issues2P\n" +
	"\x0eConfigAnalyzer\x12>\n" +
	"\aAnalyze\x12\x18.analyzer.AnalyzeRequest\x1a\x19.analyzer.AnalyzeResponseB>Z<github.com/JennyBashir/config-analyzer/gen/analyzer;analyzerb\x06proto3"
...
var file_analyzer_proto_depIdxs = []int32{
	...
	0, // 1: analyzer.ConfigAnalyzer.Analyze:input_type -> analyzer.AnalyzeRequest
	2, // 2: analyzer.ConfigAnalyzer.Analyze:output_type -> analyzer.AnalyzeResponse
